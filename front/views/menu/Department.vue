...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm () {
      ...
      this.removeDepartment(this.editedItem.dep_name);
    ...
    removeDepartment(value) {
      ...
      .then(res => {
          console.log("remove department ok", res.data.status);
      })
      .catch(err => {
          console.error(err)
      });
    ...
    updateDepartment(object) {
      console.log("---update_department---", object);

      const path='/updateDepartment';
      var payload= {
        id: object.id,
        emp_dep: object.dep_name,
      };
      axios.post(path, payload)
      .then(res => {
    ...
    createDepartment(object) {
      ...
      axios.post(path, payload)
      .then(res => {
        console.log("create department data status: ", res.data.status)
      })
      .catch(err => {
        console.error(err);
      });
